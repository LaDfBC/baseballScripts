...
def analyzePitcher(file_name, pitcher_name):
    ...
    for original_row in file:
        row = get_row_as_dict(original_row, True)
...
# MLN
# pitches, deltas = analyzePitcher("/home/george/Documents/mlnReports/mln_master_log_combined.csv", 'Calvin Huff')

#MLR
pitches = analyzePitcher("/home/george/Downloads/MiLR Stats Season 3 - All PA's.csv", 'Rich Mahogany')


result = groupValuesByRange(pitches)
print(result)